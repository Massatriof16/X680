...
BOARD_RECOVERY_DTBO_OFFSET := 16621568
BOARD_SECOND_OFFSET := 0x00f00000
BOARD_KERNEL_IMAGE_NAME := kernel
TARGET_KERNEL_ARCH := arm
TARGET_KERNEL_HEADER_ARCH := arm
TARGET_KERNEL_SOURCE := kernel/infinix/X680
TARGET_KERNEL_CONFIG := X680_defconfig
...
# Maintainer/Version
TW_DEVICE_VERSION := infinix_X680-Massatrio16
#TW_USE_NEW_MINADBD : true
    
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += \
$(TARGET_OUT_SHARED_LIBRARIES)/libkeymaster3device \
$(TARGET_OUT_SHARED_LIBRARIES)/libkeymaster3device.so \
$(TARGET_OUT_SHARED_LIBRARIES)/libsoftkeymasterdevice \
